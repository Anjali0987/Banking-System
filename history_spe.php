				...
				<div id="content_content" class="scroll">
					...
					<table class="table">
						...
						<?php
							...
							$result=mySqli_query($con,"select * from transation where send_id=".$_GET['id']);
							if(!$result)
							{
							...
							else
							{
								...
								{
									echo "<tr>";
									echo "<td>".$row[0]."</td><td>".$row[1]."</td><td>".$row[4]."</td><td>".$row[5]."</td><td>".$row[6]."</td>";
									echo "<td><a href='details.php?id=$row[0]'><input type='button' value='Details'></td></td>";
									echo"</tr>";
								}
							}
							?>
