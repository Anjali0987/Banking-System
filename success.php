		...
		<div id="image">
			...
			<div id="content" >
				...
				<div id="content_content" class="scroll">
					...
					echo 'alert("Transaction Successful.Thank you Visit Again ")';
					echo '</script>';
					$i=$_GET['id'];
					echo"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
					echo" <font size='6' color='purple' ><a class='one' href='transfer.php?id=$i'>Go To Transfer page</a></font><br>";
					echo"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
					echo" <font size='6' color='purple' ><a class='one' href='history_spe.php?id=$i'>Go To History page</a></font><br>";
					echo"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
					echo" <font size='6' color='purple' ><a class='one' href='index.html'>Go To Home page</a></font><br>";
