				...
				<div id="content_content" class="scroll">
					...
					<table class="table">
						...
						<?php
							...
							$result=mySqli_query($con,"select * from transation where trans_id=".$_GET['id']);
							if(!$result)
							{
							...
							else
							{
									...
									{
										$sen=getdetails($con,$row[2]);
										$rec=getdetails($con,$row[3]);
										echo "<tr>";
										echo "<td>".$row[0]."</td><td>".$row[2]."</td><td>".$row[1]."</td><td>".$sen[2]."</td><td>".$row[3]."</td><td>".$row[4]."</td><td>".$rec[2]."</td><td>".$row[5]."</td><td>".$row[6]."</td>";
